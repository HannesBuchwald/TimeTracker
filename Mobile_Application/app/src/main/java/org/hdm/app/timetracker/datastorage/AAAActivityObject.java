...
public class AAAActivityObject extends Object {

    private static final String TAG = "AAAActivityObject";
...
//    public boolean sub_category = false;
    ...
    public AAAActivityObject() {
        timeFrameList = new ArrayList<>();
    }

    public AAAActivityObject(String name) {
        title = name;
        timeFrameList = new ArrayList<>();
    }
