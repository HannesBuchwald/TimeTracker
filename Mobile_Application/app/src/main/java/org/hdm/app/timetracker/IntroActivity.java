...
import org.hdm.app.timetracker.adapter.IntroPageAdapter;
import org.hdm.app.timetracker.main.MainActivity;
import org.hdm.app.timetracker.models.SubjectModel;
import org.hdm.app.timetracker.tasks.InitDeviceTask;
...
public class IntroActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set content
        setContentView(org.hdm.app.timetracker.R.layout.activity_intro);

        // Instantiate ViewPager and PagerAdapter.
        introPager = (ViewPager) findViewById(org.hdm.app.timetracker.R.id.viewpager_unselected_background);
        introIndicator = (CircleIndicator) findViewById(org.hdm.app.timetracker.R.id.indicator_unselected_background);
        ...
        buttonNext = (Button) findViewById(org.hdm.app.timetracker.R.id.intro_button_next);
        ...
        buttonPrev = (Button) findViewById(org.hdm.app.timetracker.R.id.intro_button_prev);
    ...
    private void onPositionChanged(int currentPos) {
        ...
        switch(currentPos) {
            ...
            case 2:
                ...
                buttonNext.setText(getString(org.hdm.app.timetracker.R.string.intro_button_next));
                break;
            case 3:
                // insert button ready text, we are on the last step
                buttonNext.setText(getString(org.hdm.app.timetracker.R.string.intro_button_ready));
                break;
        }
    }
    ...
    private boolean checkSubjectData() {
        ...
        try {
            // get the input views
            EditText nameInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_name);
            EditText ageInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_age);
            Spinner genderSpinner = (Spinner) introPager.findViewById(org.hdm.app.timetracker.R.id.input_gender_spinner);
            Spinner educationSpinner = (Spinner) introPager.findViewById(org.hdm.app.timetracker.R.id.input_education_spinner);

            EditText tribeInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_tribe);
            EditText householdInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_household);
            EditText sizeInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_size);
            EditText weightInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_weight);

            EditText landOwnedInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_owned);
            EditText landCultivatedInput = (EditText) introPager.findViewById(org.hdm.app.timetracker.R.id.input_cultivated);
    ...
    private void finishIntro() {
        ...
        this.finishDialog = new MaterialDialog.Builder(this)
                .title(org.hdm.app.timetracker.R.string.intro_finish_dialog_title)
                .content(org.hdm.app.timetracker.R.string.intro_finish_dialog_content_one)
    ...
    InitDeviceTask.InitListener listener = new InitDeviceTask.InitListener() {
        ...
        public void onFinished(String subjectId, JSONObject activities) {
            finishDialog.setContent(org.hdm.app.timetracker.R.string.intro_finish_dialog_content_three);
