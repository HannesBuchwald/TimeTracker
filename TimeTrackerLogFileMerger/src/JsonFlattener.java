...
public class JsonFlattener {
	...
	private List<Map<String, String>> handleAsArray(String json)
			throws Exception {
		List<Map<String, String>> flatJson = null;
		try {
	...
	private void flatten(JSONArray obj, Map<String, String> flatJson,
			String prefix) {
	...
	private void flatten(JSONObject obj, Map<String, String> flatJson,
			String prefix) {
